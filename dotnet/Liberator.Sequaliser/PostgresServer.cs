...
{
    internal class PostgresServer : IDbStrategy, IDisposable
    {
        ...
        {
            get { return EnumDatabaseType.Postgres; }
        }
        ...
        public DataSet QueryDatabase(IDbCommand command)
        {
            ...
            using (NpgsqlConnection connection = new NpgsqlConnection(_connectionString))
            {
                ...
                using (NpgsqlDataAdapter dataAdapter = new NpgsqlDataAdapter((NpgsqlCommand)command))
                {
