...
{
    internal class MySqlServer : IDbStrategy, IDisposable
    {
        ...
        {
            get { return EnumDatabaseType.MySql; }
        }
        ...
        public DataSet QueryDatabase(IDbCommand command)
        {
            ...
            using (MySqlConnection connection = new MySqlConnection(_connectionString))
            {
                ...
                using (MySqlDataAdapter dataAdapter = new MySqlDataAdapter((MySqlCommand)command))
                {
