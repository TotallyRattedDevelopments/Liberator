...
namespace Liberator.Driver
{
        ...
        where TWebDriver : IWebDriver, new()
    {
        ...
        /// <param name="wait">(Optional parameter) Whether to wait for the element to reach a known state</param>
        new void ClickLinkAndWait(IWebElement element, [Optional, DefaultParameterValue(true)] bool wait);
        ...
        /// <param name="wait">(Optional parameter) Whether to wait for the element to reach a known state</param>
        new void ClickLinkAndWait(By locator, [Optional, DefaultParameterValue(true)] bool wait);
